...
SRC_URI="
https://mirrors.kernel.org/gnu/gcc/gcc-14.4.0/gcc-14.4.0.tar.xz -> gcc-14.4.0.tar.xz
...
src_prepare() {
	...
	if ! use vanilla; then
		...
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/01_all_default-fortify-source.patch" || die "gentoo patch 01_all_default-fortify-source.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/02_all_default-warn-format-security.patch" || die "gentoo patch 02_all_default-warn-format-security.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/03_all_default-warn-trampolines.patch" || die "gentoo patch 03_all_default-warn-trampolines.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/04_all_nossp-on-nostdlib.patch" || die "gentoo patch 04_all_nossp-on-nostdlib.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/05_all_alpha-mieee-default.patch" || die "gentoo patch 05_all_alpha-mieee-default.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/06_all_ia64_note.GNU-stack.patch" || die "gentoo patch 06_all_ia64_note.GNU-stack.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/07_all_libiberty-asprintf.patch" || die "gentoo patch 07_all_libiberty-asprintf.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/08_all_libiberty-pic.patch" || die "gentoo patch 08_all_libiberty-pic.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/09_all_esysroot.patch" || die "gentoo patch 09_all_esysroot.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/10_all_sh-drop-sysroot-suffix.patch" || die "gentoo patch 10_all_sh-drop-sysroot-suffix.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/11_all_ia64-TEXTREL.patch" || die "gentoo patch 11_all_ia64-TEXTREL.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/14_all_respect-build-cxxflags.patch" || die "gentoo patch 14_all_respect-build-cxxflags.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/15_all_DEF_GENTOO_GLIBCXX_ASSERTIONS.patch" || die "gentoo patch 15_all_DEF_GENTOO_GLIBCXX_ASSERTIONS.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/20_all_libstdcxx-no-vtv.patch" || die "gentoo patch 20_all_libstdcxx-no-vtv.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/22_all_default_ssp-buffer-size.patch" || die "gentoo patch 22_all_default_ssp-buffer-size.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/23_all_DEF_GENTOO_ZNOW-z-now.patch" || die "gentoo patch 23_all_DEF_GENTOO_ZNOW-z-now.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/24_all_DEF_GENTOO_SCP-fstack-clash-protection.patch" || die "gentoo patch 24_all_DEF_GENTOO_SCP-fstack-clash-protection.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/28_all_drop_CFLAGS_sed.patch" || die "gentoo patch 28_all_drop_CFLAGS_sed.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/29_all_msgfmt-libstdc++-link.patch" || die "gentoo patch 29_all_msgfmt-libstdc++-link.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/30_all_tar_libstdc++-link.patch" || die "gentoo patch 30_all_tar_libstdc++-link.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/32_all_time64_ssemath.patch" || die "gentoo patch 32_all_time64_ssemath.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/70_all_PR117854-config-nvptx-fix-bashisms-with-gen-copyright.sh-use.patch" || die "gentoo patch 70_all_PR117854-config-nvptx-fix-bashisms-with-gen-copyright.sh-use.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/79_all_sanitizer_time64.patch" || die "gentoo patch 79_all_sanitizer_time64.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/80_all_genoutput-Accelerate-the-place_operands-function.patch" || die "gentoo patch 80_all_genoutput-Accelerate-the-place_operands-function.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/81_all_genemit-Distribute-evenly-to-files-PR111600.patch" || die "gentoo patch 81_all_genemit-Distribute-evenly-to-files-PR111600.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-14.3.0/82_all_genrecog-Split-into-separate-partitions-PR111600.patch" || die "gentoo patch 82_all_genrecog-Split-into-separate-partitions-PR111600.patch failed"
