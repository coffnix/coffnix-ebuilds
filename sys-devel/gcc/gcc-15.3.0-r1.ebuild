...
SRC_URI="
https://mirrors.kernel.org/gnu/gcc/gcc-15.3.0/gcc-15.3.0.tar.xz -> gcc-15.3.0.tar.xz
https://mirrors.kernel.org/gnu/gmp/gmp-6.2.1.tar.xz -> gmp-6.2.1.tar.xz
https://www.mpfr.org/mpfr-4.1.0/mpfr-4.1.0.tar.xz -> mpfr-4.1.0.tar.xz
https://mirrors.kernel.org/gnu/mpc/mpc-1.2.1.tar.gz -> mpc-1.2.1.tar.gz"
...
src_unpack() {
	unpack $GCC_A
	( unpack mpc-1.2.1.tar.gz && mv ${WORKDIR}/mpc-1.2.1 ${S}/mpc ) || die "mpc setup fail"
	( unpack mpfr-4.1.0.tar.xz && mv ${WORKDIR}/mpfr-4.1.0 ${S}/mpfr ) || die "mpfr setup fail"
	( unpack gmp-6.2.1.tar.xz && mv ${WORKDIR}/gmp-6.2.1 ${S}/gmp ) || die "gmp setup fail"
...
src_prepare() {
	...
	if ! use vanilla; then
		...
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/01_all_default-fortify-source.patch" || die "gentoo patch 01_all_default-fortify-source.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/02_all_default-warn-format-security.patch" || die "gentoo patch 02_all_default-warn-format-security.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/03_all_default-warn-trampolines.patch" || die "gentoo patch 03_all_default-warn-trampolines.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/04_all_nossp-on-nostdlib.patch" || die "gentoo patch 04_all_nossp-on-nostdlib.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/05_all_alpha-mieee-default.patch" || die "gentoo patch 05_all_alpha-mieee-default.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/06_all_ia64_note.GNU-stack.patch" || die "gentoo patch 06_all_ia64_note.GNU-stack.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/08_all_libiberty-pic.patch" || die "gentoo patch 08_all_libiberty-pic.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/09_all_esysroot.patch" || die "gentoo patch 09_all_esysroot.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/10_all_sh-drop-sysroot-suffix.patch" || die "gentoo patch 10_all_sh-drop-sysroot-suffix.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/11_all_ia64-TEXTREL.patch" || die "gentoo patch 11_all_ia64-TEXTREL.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/14_all_respect-build-cxxflags.patch" || die "gentoo patch 14_all_respect-build-cxxflags.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/15_all_DEF_GENTOO_GLIBCXX_ASSERTIONS.patch" || die "gentoo patch 15_all_DEF_GENTOO_GLIBCXX_ASSERTIONS.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/20_all_libstdcxx-no-vtv.patch" || die "gentoo patch 20_all_libstdcxx-no-vtv.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/22_all_default_ssp-buffer-size.patch" || die "gentoo patch 22_all_default_ssp-buffer-size.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/23_all_DEF_GENTOO_ZNOW-z-now.patch" || die "gentoo patch 23_all_DEF_GENTOO_ZNOW-z-now.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/24_all_DEF_GENTOO_SCP-fstack-clash-protection.patch" || die "gentoo patch 24_all_DEF_GENTOO_SCP-fstack-clash-protection.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/26_all_enable-cet.patch" || die "gentoo patch 26_all_enable-cet.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/28_all_drop_CFLAGS_sed.patch" || die "gentoo patch 28_all_drop_CFLAGS_sed.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/29_all_msgfmt-libstdc++-link.patch" || die "gentoo patch 29_all_msgfmt-libstdc++-link.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/30_all_tar_libstdc++-link.patch" || die "gentoo patch 30_all_tar_libstdc++-link.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/31_all_testsuite-fortran-pass-Wcomplain-wrong-lang-where-ap.patch" || die "gentoo patch 31_all_testsuite-fortran-pass-Wcomplain-wrong-lang-where-ap.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/32_all_time64.patch" || die "gentoo patch 32_all_time64.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/33_all_PR80677-cross-limits.patch" || die "gentoo patch 33_all_PR80677-cross-limits.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/34_all_time64_ssemath.patch" || die "gentoo patch 34_all_time64_ssemath.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/35_all_checking-gc-use-heuristics.patch" || die "gentoo patch 35_all_checking-gc-use-heuristics.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/76_all_PR117854-config-nvptx-fix-bashisms-with-gen-copyright.sh-use.patch" || die "gentoo patch 76_all_PR117854-config-nvptx-fix-bashisms-with-gen-copyright.sh-use.patch failed"
		eapply "${FILESDIR}/gentoo-patches/gcc-15.2.0/84_all_PR116975-GDCFLAGS.patch" || die "gentoo patch 84_all_PR116975-GDCFLAGS.patch failed"
