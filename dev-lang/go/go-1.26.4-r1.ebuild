...
SRC_URI="
https://go.dev/dl/go${PV}.src.tar.gz -> go${PV}.src.tar.gz
amd64? ( https://go.dev/dl/go${PV}.linux-amd64.tar.gz -> go${PV}-bootstrap.linux-amd64.tar.gz )
x86? ( https://go.dev/dl/go${PV}.linux-386.tar.gz -> go${PV}-bootstrap.linux-386.tar.gz )
arm64? ( https://go.dev/dl/go${PV}.linux-arm64.tar.gz -> go${PV}-bootstrap.linux-arm64.tar.gz )
armv6? ( https://go.dev/dl/go${PV}.linux-armv6l.tar.gz -> go${PV}-bootstrap.linux-armv6l.tar.gz )
"
LICENSE="BSD"
SLOT="0"
KEYWORDS="*"
