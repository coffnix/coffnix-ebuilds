...
SRC_URI="
https://download.qt.io/archive/qt/5.15/5.15.17/submodules/qtwebengine-everywhere-opensource-src-5.15.17.tar.xz -> qtwebengine-everywhere-opensource-src-5.15.17.tar.xz
...
DEPEND="${RDEPEND}
"
S="${WORKDIR}/qtwebengine-everywhere-src-5.15.17"
pkg_setup() {
