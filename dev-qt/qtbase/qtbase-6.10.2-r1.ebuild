...
SRC_URI="https://download.qt.io/archive/qt/6.10/6.10.2/submodules/qtbase-everywhere-src-6.10.2.tar.xz -> qtbase-everywhere-src-6.10.2.tar.xz"
SLOT="6"
KEYWORDS="*"
IUSE="+X +dbus +widgets +xml +network +concurrent brotli cups gles2-only gtk gssapi +gui journald libinput libproxy mysql postgres renderdoc +sql sqlite vulkan wayland zstd"
