...
SRC_URI="https://github.com/rust-lang/rust-${PN}/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	https://crates.io/api/v1/crates/annotate-snippets/0.11.4/download -> annotate-snippets-0.11.4.crate
	...
	https://crates.io/api/v1/crates/bitflags/2.2.1/download -> bitflags-2.2.1.crate
	https://crates.io/api/v1/crates/block/0.1.6/download -> block-0.1.6.crate
	https://crates.io/api/v1/crates/cc/1.2.2/download -> cc-1.2.2.crate
	https://crates.io/api/v1/crates/cexpr/0.6.0/download -> cexpr-0.6.0.crate
	https://crates.io/api/v1/crates/cfg-if/1.0.0/download -> cfg-if-1.0.0.crate
	https://crates.io/api/v1/crates/clang-sys/1.8.1/download -> clang-sys-1.8.1.crate
	https://crates.io/api/v1/crates/clap/4.1.4/download -> clap-4.1.4.crate
	https://crates.io/api/v1/crates/clap_complete/4.2.0/download -> clap_complete-4.2.0.crate
	https://crates.io/api/v1/crates/clap_derive/4.1.0/download -> clap_derive-4.1.0.crate
	https://crates.io/api/v1/crates/clap_lex/0.3.1/download -> clap_lex-0.3.1.crate
	https://crates.io/api/v1/crates/either/1.13.0/download -> either-1.13.0.crate
	https://crates.io/api/v1/crates/env_logger/0.10.0/download -> env_logger-0.10.0.crate
	https://crates.io/api/v1/crates/env_logger/0.8.4/download -> env_logger-0.8.4.crate
	https://crates.io/api/v1/crates/errno/0.3.10/download -> errno-0.3.10.crate
	...
	https://crates.io/api/v1/crates/hermit-abi/0.4.0/download -> hermit-abi-0.4.0.crate
	...
	https://crates.io/api/v1/crates/is-terminal/0.4.13/download -> is-terminal-0.4.13.crate
	...
	https://crates.io/api/v1/crates/libloading/0.8.6/download -> libloading-0.8.6.crate
	...
	https://crates.io/api/v1/crates/malloc_buf/0.0.6/download -> malloc_buf-0.0.6.crate
	...
	https://crates.io/api/v1/crates/objc/0.2.7/download -> objc-0.2.7.crate
	...
	https://crates.io/api/v1/crates/owo-colors/4.1.0/download -> owo-colors-4.1.0.crate
	https://crates.io/api/v1/crates/prettyplease/0.2.25/download -> prettyplease-0.2.25.crate
	...
	https://crates.io/api/v1/crates/quickcheck/1.0.3/download -> quickcheck-1.0.3.crate
	...
	https://crates.io/api/v1/crates/rustc-hash/2.1.0/download -> rustc-hash-2.1.0.crate
	...
	https://crates.io/api/v1/crates/similar/2.6.0/download -> similar-2.6.0.crate
