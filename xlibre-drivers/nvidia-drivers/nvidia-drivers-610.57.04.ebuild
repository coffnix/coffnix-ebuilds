...
SRC_URI="
amd64? ( https://download.nvidia.com/XFree86/Linux-x86_64/${PV}/NVIDIA-Linux-x86_64-${PV}-no-compat32.run -> NVIDIA-Linux-x86_64-${PV}-no-compat32.run )
arm64? ( https://download.nvidia.com/XFree86/Linux-aarch64/${PV}/NVIDIA-Linux-aarch64-${PV}.run -> NVIDIA-Linux-aarch64-${PV}.run )
"
