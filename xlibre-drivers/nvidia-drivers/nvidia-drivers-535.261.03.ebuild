...
SRC_URI="
amd64? ( http://download.nvidia.com/XFree86/Linux-x86_64/535.261.03/NVIDIA-Linux-x86_64-535.261.03-no-compat32.run -> NVIDIA-Linux-x86_64-535.261.03-no-compat32.run )
arm64? ( http://download.nvidia.com/XFree86/Linux-aarch64/535.261.03/NVIDIA-Linux-aarch64-535.261.03.run -> NVIDIA-Linux-aarch64-535.261.03.run )"
