...
SRC_URI="
amd64? ( https://download.nvidia.com/XFree86/Linux-x86_64/580.105.08/NVIDIA-Linux-x86_64-580.105.08-no-compat32.run -> NVIDIA-Linux-x86_64-580.105.08-no-compat32.run )"

#arm64? ( https://download.nvidia.com/XFree86/Linux-aarch64/580.105.08/NVIDIA-Linux-aarch64-580.105.08.run -> NVIDIA-Linux-aarch64-580.105.08.run )
