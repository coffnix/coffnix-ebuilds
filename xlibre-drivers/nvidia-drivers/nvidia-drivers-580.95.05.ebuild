...
SRC_URI="
amd64? ( http://download.nvidia.com/XFree86/Linux-x86_64/580.95.05/NVIDIA-Linux-x86_64-580.95.05-no-compat32.run -> NVIDIA-Linux-x86_64-580.95.05-no-compat32.run )
arm64? ( http://download.nvidia.com/XFree86/Linux-aarch64/580.95.05/NVIDIA-Linux-aarch64-580.95.05.run -> NVIDIA-Linux-aarch64-580.95.05.run )"
