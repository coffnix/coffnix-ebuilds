...
SRC_URI="
amd64? ( https://download.nvidia.com/XFree86/Linux-x86_64/595.45.04/NVIDIA-Linux-x86_64-595.45.04-no-compat32.run -> NVIDIA-Linux-x86_64-595.45.04-no-compat32.run )"

#arm64? ( https://download.nvidia.com/XFree86/Linux-aarch64/595.45.04/NVIDIA-Linux-aarch64-595.45.04.run -> NVIDIA-Linux-aarch64-595.45.04.run )
