...
SRC_URI="
amd64? ( http://download.nvidia.com/XFree86/Linux-x86_64/550.163.01/NVIDIA-Linux-x86_64-550.163.01-no-compat32.run -> NVIDIA-Linux-x86_64-550.163.01-no-compat32.run )
arm64? ( http://download.nvidia.com/XFree86/Linux-aarch64/550.163.01/NVIDIA-Linux-aarch64-550.163.01.run -> NVIDIA-Linux-aarch64-550.163.01.run )"
