...
SRC_URI="https://github.com/curl/curl/releases/download/curl-8_18_0/curl-8.18.0.tar.gz -> curl-8.18.0.tar.gz"
...
DOCS=( CHANGES.md README docs/{FEATURES.md,INTERNALS.md,BUGS.md,CONTRIBUTE.md} )
