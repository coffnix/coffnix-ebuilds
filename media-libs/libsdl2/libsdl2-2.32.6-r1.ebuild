...
SRC_URI="https://github.com/libsdl-org/SDL/tarball/6510d6ccbf446e058ae8ed95233f59057312df02 -> SDL-2.32.6-6510d6c.tar.gz"
...
CDEPEND="
	...
	gles1? (
		|| (
			...
			media-libs/mesa-sky1[gles1]
		)
	)
	gles2? (
		|| (
			media-libs/mesa[gles2]
			media-libs/mesa-sky1[gles2]
		)
	)
	ibus? ( app-i18n/ibus )
	jack? ( virtual/jack )
	...
	wayland? (
		...
		|| (
			...
			media-libs/mesa-sky1[egl(+),gles2,wayland]
		)
