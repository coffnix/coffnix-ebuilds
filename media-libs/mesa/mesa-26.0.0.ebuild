...
IUSE="sky1-patches cpu_flags_x86_sse2 d3d9 debug +egl +gbm gles1 +gles2 +glvnd +llvm
...
#SRC_URI="https://github.com/Sky1-Linux/mesa-sky1/archive/refs/tags/mesa-${PV}.tar.gz -> mesa-${PV}.tar.gz"
SRC_URI="
	!sky1-patches? ( https://archive.mesa3d.org/mesa-${PV}.tar.xz -> mesa-${PV}.tar.xz )
...
REQUIRED_USE="
	...
	vulkan? ( || ( video_cards_freedreno video_cards_intel video_cards_panfrost video_cards_radeonsi video_cards_v3d video_cards_virgl ) )
	vulkan? ( video_cards_radeonsi? ( llvm ) )
	vulkan-overlay? ( vulkan )
	video_cards_radeon? ( llvm )
	video_cards_r300? ( llvm )
